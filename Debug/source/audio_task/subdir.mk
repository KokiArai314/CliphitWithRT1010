...
C_SRCS += \
../source/audio_task/audio_player.c \
../source/audio_task/audio_task.c 

C_DEPS += \
./source/audio_task/audio_player.d \
./source/audio_task/audio_task.d 

OBJS += \
./source/audio_task/audio_player.o \
./source/audio_task/audio_task.o 


# Each subdirectory must supply rules for building sources it contributes
source/audio_task/%.o: ../source/audio_task/%.c source/audio_task/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-audio_task

clean-source-2f-audio_task:
	-$(RM) ./source/audio_task/audio_player.d ./source/audio_task/audio_player.o ./source/audio_task/audio_task.d ./source/audio_task/audio_task.o

.PHONY: clean-source-2f-audio_task
