...
source/usb_device/%.o: ../source/usb_device/%.c source/usb_device/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-usb_device

clean-source-2f-usb_device:
	-$(RM) ./source/usb_device/usb_device_descriptor.d ./source/usb_device/usb_device_descriptor.o

.PHONY: clean-source-2f-usb_device
