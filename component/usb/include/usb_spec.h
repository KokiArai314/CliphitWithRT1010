...
#define USB_DESCRIPTOR_LENGTH_OTHER_SPEED_CONFIGURATION	(0x09U)
...
#define USB_DESCRIPTOR_LENGTH_INTERFACE_ASSOSIATION	(0x08U)		/// @note interface assosiation descriptor
