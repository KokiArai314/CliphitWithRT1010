...
/* The max packet size should be increased otherwise if host send data larger than max packet size will cause DMA error. */
...
usb_device_interface_struct_t g_UsbDeviceAudioInStreamInterface[] = {
    ...
    },
    {
        1U,
        {
            USB_AUDIO_IN_STREAM_ENDPOINT_COUNT,
...
usb_device_interfaces_struct_t
    g_UsbDeviceAudioInterfaces[USB_AUDIO_PLAYER_INTERFACE_COUNT - USB_MIDI_PLAYER_INTERFACE_COUNT] = {
        {
...
usb_device_interface_struct_t g_UsbDeviceMidiStreamInterface[] = {{0,
                                                                   {
                                                                       USB_MIDI_STREAM_ENDPOINT_COUNT,
                                                                       g_UsbDeviceMidiEndpoints,
                                                                   },
                                                                   NULL}};
...
usb_device_interface_list_t g_UsbDeviceMidinterfaceList[USB_DEVICE_CONFIGURATION_COUNT] = {
    {
        USB_MIDI_PLAYER_INTERFACE_COUNT,
        g_MidiInterfaces,
    },
};
...
uint8_t g_UsbDeviceDescriptor[] = {
    ...
    0x44U,
    0x09U, /* Vendor ID (assigned by the USB-IF) */
...
uint8_t g_UsbDeviceConfigurationDescriptor[] = {
    ...
    USB_SHORT_GET_LOW(SIZE_OF_TOTAL_CONFIG_DESC),
    USB_SHORT_GET_HIGH(SIZE_OF_TOTAL_CONFIG_DESC), /* Total length of data returned for this configuration. */
    ...
    */
    ...
    USB_DESCRIPTOR_LENGTH_INTERFACE_ASSOSIATION, USB_DESCRIPTOR_TYPE_INTERFACE_ASSOCIATION,
    ...
    0x00U, USB_AUDIO_CLASS,            /*The interface implements the Audio Interface class  */
    ...
    USB_AUDIO_SPEAKER_CONTROL_OUTPUT_TERMINAL_ID, /* Constant uniquely identifying the Terminal within the audio
                                                     function*/
    0x03U, 0x06U, /* A Terminal dealing with a signal carried over an endpoint in an AudioStreaming interface */
    ...
    USB_AUDIO_RECORDER_CONTROL_INPUT_TERMINAL_ID, /* Constant uniquely identifying the Terminal within the audio
             function. This value is used in all requests
             to address this Terminal.  */
    0x03U, 0x06U, /* A generic microphone that does not fit under any of the other classifications.  */
    0x00U,        /* This Input Terminal has no association  */
    0x02U,        /* This Terminal's output audio channel cluster has 1 logical output channels  */
    0x03U, 0x00U, /* Spatial locations present in the cluster */
    0x00U,        /* Index of a string descriptor, describing the name of the first logical channel.   */
    ...
    USB_MIDI_CONTROL_INTERFACE_HEADER_LENGTH, 0x00U, 0x01U, /* bInCollection */
    ...
    (USB_MIDI_ENDP_MAX_PACKET_SIZE & 0xFF), (USB_MIDI_ENDP_MAX_PACKET_SIZE >> 8), /* wMaxPacketSize */
...
uint8_t g_UsbDeviceConfigurationDescriptor[] = {
    ...
    USB_SHORT_GET_LOW(
        ...
        /* Interface 4 */
        USB_DESCRIPTOR_LENGTH_INTERFACE + SIZE_OF_CS_MS_IF_HDR_DESC + SIZE_OF_MIDI_IN_JACK_DESC +
        SIZE_OF_MIDI_OUT_JACK_DESC + SIZE_OF_MIDI_OUT_JACK_DESC + SIZE_OF_MIDI_IN_JACK_DESC +
        SIZE_OF_STD_MS_BD_EP_DESC + SIZE_OF_CS_MS_BD_EP_DESC + SIZE_OF_STD_MS_BD_EP_DESC + SIZE_OF_CS_MS_BD_EP_DESC),
    USB_SHORT_GET_HIGH(
        USB_DESCRIPTOR_LENGTH_CONFIGURE + USB_DESCRIPTOR_LENGTH_INTERFACE + USB_AUDIO_CONTROL_INTERFACE_HEADER_LENGTH +
        USB_AUDIO_INPUT_TERMINAL_ONLY_DESC_SIZE + USB_AUDIO_OUTPUT_TERMINAL_ONLY_DESC_SIZE +
        USB_AUDIO_INPUT_TERMINAL_ONLY_DESC_SIZE + USB_AUDIO_OUTPUT_TERMINAL_ONLY_DESC_SIZE +
        ...
        USB_DESCRIPTOR_LENGTH_INTERFACE + SIZE_OF_CS_MS_IF_HDR_DESC + SIZE_OF_MIDI_IN_JACK_DESC +
        SIZE_OF_MIDI_OUT_JACK_DESC + SIZE_OF_MIDI_OUT_JACK_DESC + SIZE_OF_MIDI_IN_JACK_DESC +
        SIZE_OF_STD_MS_BD_EP_DESC + SIZE_OF_CS_MS_BD_EP_DESC + SIZE_OF_STD_MS_BD_EP_DESC +
        SIZE_OF_CS_MS_BD_EP_DESC), /* Total length of data returned for this configuration. */
...
uint8_t g_UsbDeviceOtherSpeedConfigurationDescriptor[] = {
    USB_DESCRIPTOR_LENGTH_OTHER_SPEED_CONFIGURATION, USB_DESCRIPTOR_TYPE_OTHER_SPEED_CONFIGURATION,
    USB_SHORT_GET_LOW(SIZE_OF_TOTAL_CONFIG_DESC),
    USB_SHORT_GET_HIGH(SIZE_OF_TOTAL_CONFIG_DESC), /* Total length of data returned for this configuration. */
    USB_AUDIO_PLAYER_INTERFACE_COUNT, USB_AUDIO_MIDI_CONFIGURE_INDEX, /* Value to use as an argument to the
                                                    SetConfiguration() request to select this configuration */
    0x00U, /* Index of string descriptor describing this configuration */
    (USB_DESCRIPTOR_CONFIGURE_ATTRIBUTE_D7_MASK) |
        (USB_DEVICE_CONFIG_SELF_POWER << USB_DESCRIPTOR_CONFIGURE_ATTRIBUTE_SELF_POWERED_SHIFT) |
...
#if SUPPORT_USB_HIGH_SPEED
  /* bInterval */
  g_UsbDeviceConfigurationDescriptor[OFFSET_EP1_OUT_BINTERVAL] =
      (USB_SPEED_HIGH == speed) ? HS_ISO_OUT_ENDP_INTERVAL : FS_ISO_OUT_ENDP_INTERVAL;
  g_UsbDeviceConfigurationDescriptor[OFFSET_EP1_IN_BINTERVAL] =
      (USB_SPEED_HIGH == speed) ? HS_ISO_IN_ENDP_INTERVAL : FS_ISO_IN_ENDP_INTERVAL;
  g_UsbDeviceConfigurationDescriptor[OFFSET_EP3_IN_BINTERVAL] =
      (USB_SPEED_HIGH == speed) ? HS_ISO_IN_ENDP_INTERVAL : FS_ISO_IN_ENDP_INTERVAL;
...
usb_status_t USB_DeviceGetOtherSpeedConfigurationDescriptor(
    ...
    usb_device_get_device_other_speed_configuration_descriptor_struct_t *deviceOtherSpeedConfigDescriptor) {
