...
#define SIZE_OF_TOTAL_CONFIG_DESC                                                                                    \
  USB_DESCRIPTOR_LENGTH_CONFIGURE                                                                                    \
  +USB_DESCRIPTOR_LENGTH_INTERFACE_ASSOSIATION + USB_DESCRIPTOR_LENGTH_INTERFACE +                                   \
      ...
      USB_AUDIO_OUTPUT_TERMINAL_ONLY_DESC_SIZE + USB_DESCRIPTOR_LENGTH_INTERFACE + USB_DESCRIPTOR_LENGTH_INTERFACE + \
      USB_AUDIO_STREAMING_IFACE_DESC_SIZE + USB_AUDIO_STREAMING_TYPE_I_DESC_SIZE +                                   \
      USB_ENDPOINT_AUDIO_DESCRIPTOR_LENGTH + USB_AUDIO_STREAMING_ENDP_DESC_SIZE +                                    \
      USB_ENDPOINT_AUDIO_DESCRIPTOR_LENGTH + USB_DESCRIPTOR_LENGTH_INTERFACE + USB_DESCRIPTOR_LENGTH_INTERFACE +     \
      USB_AUDIO_STREAMING_IFACE_DESC_SIZE + USB_AUDIO_STREAMING_TYPE_I_DESC_SIZE +                                   \
      USB_ENDPOINT_AUDIO_DESCRIPTOR_LENGTH + USB_AUDIO_STREAMING_ENDP_DESC_SIZE +                                    \
      USB_DESCRIPTOR_LENGTH_INTERFACE_ASSOSIATION + USB_DESCRIPTOR_LENGTH_INTERFACE +                                \
      USB_MIDI_CONTROL_INTERFACE_HEADER_LENGTH + USB_DESCRIPTOR_LENGTH_INTERFACE + SIZE_OF_CS_MS_IF_HDR_DESC +       \
      SIZE_OF_MIDI_IN_JACK_DESC + SIZE_OF_MIDI_OUT_JACK_DESC + SIZE_OF_MIDI_OUT_JACK_DESC +                          \
      SIZE_OF_MIDI_IN_JACK_DESC + SIZE_OF_STD_MS_BD_EP_DESC + SIZE_OF_CS_MS_BD_EP_DESC + SIZE_OF_STD_MS_BD_EP_DESC + \
      SIZE_OF_CS_MS_BD_EP_DESC
...
#define SIZE_OF_INTERFACE3 USB_DESCRIPTOR_LENGTH_INTERFACE + USB_MIDI_CONTROL_INTERFACE_HEADER_LENGTH

/* bInterval */
#define OFFSET_EP1_OUT_BINTERVAL                                                                        \
  USB_DESCRIPTOR_LENGTH_CONFIGURE                                                                       \
  +USB_DESCRIPTOR_LENGTH_INTERFACE_ASSOSIATION + SIZE_OF_INTERFACE0 + USB_DESCRIPTOR_LENGTH_INTERFACE + \
      USB_DESCRIPTOR_LENGTH_INTERFACE + USB_AUDIO_STREAMING_IFACE_DESC_SIZE + USB_AUDIO_STREAMING_TYPE_I_DESC_SIZE + 6
...
#define OFFSET_EP1_IN_BINTERVAL                                                                                      \
  ...
  +USB_DESCRIPTOR_LENGTH_INTERFACE_ASSOSIATION + SIZE_OF_INTERFACE0 + USB_DESCRIPTOR_LENGTH_INTERFACE +              \
      ...
      USB_ENDPOINT_AUDIO_DESCRIPTOR_LENGTH + USB_AUDIO_STREAMING_ENDP_DESC_SIZE + 6

#define OFFSET_EP3_IN_BINTERVAL                                                                                 \
  USB_DESCRIPTOR_LENGTH_CONFIGURE                                                                               \
  +USB_DESCRIPTOR_LENGTH_INTERFACE_ASSOSIATION + SIZE_OF_INTERFACE0 + SIZE_OF_INTERFACE1 +                      \
      USB_DESCRIPTOR_LENGTH_INTERFACE + USB_DESCRIPTOR_LENGTH_INTERFACE + USB_AUDIO_STREAMING_IFACE_DESC_SIZE + \
      USB_AUDIO_STREAMING_TYPE_I_DESC_SIZE + 6

/* Max Packet SIZE */
#define OFFSET_EP2_OUT_MAX_PACKET_SIZE                                                                          \
  USB_DESCRIPTOR_LENGTH_CONFIGURE                                                                               \
  +USB_DESCRIPTOR_LENGTH_INTERFACE_ASSOSIATION + SIZE_OF_INTERFACE0 + SIZE_OF_INTERFACE1 + SIZE_OF_INTERFACE2 + \
      USB_DESCRIPTOR_LENGTH_INTERFACE_ASSOSIATION + SIZE_OF_INTERFACE3 + USB_DESCRIPTOR_LENGTH_INTERFACE +      \
      SIZE_OF_CS_MS_IF_HDR_DESC + SIZE_OF_MIDI_IN_JACK_DESC + SIZE_OF_MIDI_OUT_JACK_DESC +                      \
      SIZE_OF_MIDI_OUT_JACK_DESC + SIZE_OF_MIDI_IN_JACK_DESC + 4
...
#define OFFSET_EP2_IN_MAX_PACKET_SIZE                                                                                 \
  ...
  +USB_DESCRIPTOR_LENGTH_INTERFACE_ASSOSIATION + SIZE_OF_INTERFACE0 + SIZE_OF_INTERFACE1 + SIZE_OF_INTERFACE2 +       \
      USB_DESCRIPTOR_LENGTH_INTERFACE_ASSOSIATION + SIZE_OF_INTERFACE3 + USB_DESCRIPTOR_LENGTH_INTERFACE +            \
      SIZE_OF_CS_MS_IF_HDR_DESC + SIZE_OF_MIDI_IN_JACK_DESC + SIZE_OF_MIDI_OUT_JACK_DESC +                            \
      SIZE_OF_MIDI_OUT_JACK_DESC + SIZE_OF_MIDI_IN_JACK_DESC + SIZE_OF_STD_MS_BD_EP_DESC + SIZE_OF_CS_MS_BD_EP_DESC + \
      4
