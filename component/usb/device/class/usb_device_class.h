...
/*! @brief Obtains the control get device other speed configuration descriptor request structure. */
typedef struct _usb_device_get_device_other_speed_configuration_descriptor_struct
{
    uint8_t *buffer; /*!< Pass the buffer address. */
    uint32_t length; /*!< Pass the buffer length. */
} usb_device_get_device_other_speed_configuration_descriptor_struct_t;
