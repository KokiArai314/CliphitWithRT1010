  ...
  switch (event) {
    ...
    case kUSB_DeviceEventSetInterface:
      if (g_composite.audioPlayer.attach) {
        ...
        USB_DeviceAudioSetInterface(g_composite.audioPlayer.audioHandle, interface, alternateSetting);
        error = kStatus_USB_Success;
      }
      break;
    ...
    case kUSB_DeviceEventGetDeviceQualifierDescriptor:
      if (param) {
        ...
        error = USB_DeviceGetDeviceQualifierDescriptor(handle,
    ...
    case kUSB_DeviceEventGetOtherSpeedConfigurationDescriptor:
      if (param) {
        ...
        error = USB_DeviceGetOtherSpeedConfigurationDescriptor(
            handle, (usb_device_get_device_other_speed_configuration_descriptor_struct_t *)param);
      }
      break;
    default:
      break;
