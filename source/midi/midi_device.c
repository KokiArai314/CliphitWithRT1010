...
static void SendProgramWriteResult(uint8_t programNo) { SendWriteResult(SFC_WRITE_CMP, programNo); }
...
static void MidiRxProc_AnalyzeID(void) {
  if ((s_ExclRxBuff[0] == AMP_PRODUCT_ID_1ST) && (s_ExclRxBuff[1] == AMP_PRODUCT_ID_2ND) &&
